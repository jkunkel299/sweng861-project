...
class TestMusicSearch(unittest.TestCase):
    ...
    def test_recent_albums_return(self):
        ...
        EXPECTED_1 = [{'cover': 'https://i.scdn.co/image/ab67616d00004851dc2bacae1dca83d26e2b1949', 'name': "1989 (Taylor's Version) [Deluxe]", 'date': '2023-10-27'}, 
                      {'cover': 'https://i.scdn.co/image/ab67616d00004851904445d70d04eb24d6bb79ac', 'name': "1989 (Taylor's Version)", 'date': '2023-10-26'}, 
                      {'cover': 'https://i.scdn.co/image/ab67616d000048510b04da4f224b51ff86e0a481', 'name': "Speak Now (Taylor's Version)", 'date': '2023-07-07'}, 
                      {'cover': 'https://i.scdn.co/image/ab67616d00004851fa747621a53c8e2cc436dee0', 'name': 'Midnights (The Til Dawn Edition)', 'date': '2023-05-26'}, 
                      {'cover': 'https://i.scdn.co/image/ab67616d00004851e0b60c608586d88252b8fbc0', 'name': 'Midnights (3am Edition)', 'date': '2022-10-22'}]
        EXPECTED_2 = [{'cover': 'https://i.scdn.co/image/ab67616d000048511e7c02b74d1beefca663be04', 'name': 'five seconds flat', 'date': '2022-04-08'}, 
                      {'cover': 'https://i.scdn.co/image/ab67616d000048516c1ff9424f275a8af7c72551', 'name': 'Give Me A Minute', 'date': '2020-08-13'}]
        EXPECTED_3 = [{'cover': 'https://i.scdn.co/image/ab67616d00004851a63bdfd4a6e9b3c9f4f2e91d', 'name': 'Unreal Unearth', 'date': '2023-08-18'}, 
                      {'cover': 'https://i.scdn.co/image/ab67616d000048515795e01c151ba5a8ce4bd295', 'name': 'Wasteland, Baby!', 'date': '2019-03-01'}, 
                      {'cover': 'https://i.scdn.co/image/ab67616d000048510359731f8f8240580be3a9ee', 'name': 'Hozier', 'date': '2014-10-07'}, 
                      {'cover': 'https://i.scdn.co/image/ab67616d000048514ca68d59a4a29c856a4a39c2', 'name': 'Hozier (Expanded Edition)', 'date': '2014-09-19'}]
        EXPECTED_4 = ""
    ...
    def test_top_songs(self):
        ...
        # Set expected values for results arrays
        EXPECTED_1 = [{'id': '1BxfuPKGuaTgP7aM0Bbdwr', 
                      ...
                      {'id': '4R2kfaDFhslZEMJqAFNpdd', 
                       ...
                       'album': 'folklore', 
                       'date': '2020-07-24'}]
        EXPECTED_2 = [{'id': '2L9N0zZnd37dwF0clgxMGI', 
                      ...
                      {'id': '1VsciQwDYOAyDw2FX6D062', 
                       ...
                       'date': '2023-11-03'}]
        EXPECTED_3 = [{'id': '1CS7Sd1u5tWkstBhpssyjP', 
    ...
    def test_get_tracks_from_search(self):
        ...
        # Set expected values for results arrays
        EXPECTED_1 = [{'cover': 'https://i.scdn.co/image/ab67616d00004851e787cffec20aa2a396a61647', 
                       'name': 'Lover', 
                       'preview': None, 
                       'artist': 'Taylor Swift', 
                       'album': 'Lover', 
                      ...
                      {'cover': 'https://i.scdn.co/image/ab67616d0000485100540a663c95a4c2ec8a8c0c', 
                       ...
                       'album': 'Lover/Friend', 
                       'date': '2023-11-30'}]
        EXPECTED_2 = [{'cover': 'https://i.scdn.co/image/ab67616d00004851cd222052a2594be29a6616b5', 
                       'name': 'Jaded', 
